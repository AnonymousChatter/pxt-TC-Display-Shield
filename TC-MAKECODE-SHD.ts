...
/**
 ...
 namespace TCMKCD {
     ...
     function send(command: TFTCommands, parameter: Array<number>): void {
         ...
         // - Remove CS - // pins.digitalWritePin(DigitalPin.P0, 0)
         // Send command
         ...
         // - Remove CS - // pins.digitalWritePin(DigitalPin.P0, 1)
     }
     ...
     function exitDataMode(): void {
         // - Remove CS - // pins.digitalWritePin(DigitalPin.P0, 1) // de-elect the TFT as SPI target
